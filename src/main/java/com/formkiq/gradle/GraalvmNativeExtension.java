...
public class GraalvmNativeExtension {
    ...
    /** Build ARM or AMD64 */
    private Property<String> architecture;
    ...
    public GraalvmNativeExtension(final ObjectFactory objects) {
        ...
        this.architecture = objects.property(String.class);
    }
    ...
    public String getArchitecture() {return this.architecture.getOrElse(DEFAULT_ARCHITECTURE);}
